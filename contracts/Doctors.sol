...
contract Doctors {
    ...
    ****/
    function addDoctorName(string memory _doctorId, string memory _name)
        public
    {
    ...
    ****/
    function getDoctorName(string memory _doctorId)
        public
        view
    ...
    ****/
    ...
    params _doctorId -  doctor name
    ****/
    function getDoctorSpeciality(string memory _doctorId)
        public
        view
        returns (string memory)
    {
    ...
    params _doctorId - doctor'a generated Id.
    ****/
    function addDoctorHospital(string memory _doctorId, string memory _hospital)
        public
    {
    ...
    params _doctorId -  doctor name
    ****/
    function getDoctorHospital(string memory _doctorId)
        public
        view
        returns (string memory)
    {
    ...
    params _doctorId - doctor'a generated Id.
    ****/
    function addDoctorGender(string memory _doctorId, string memory _gender)
        public
    {
    ...
    params _doctorId -  doctor name
    ****/
    function getDoctorGender(string memory _doctorId)
        public
        view
        returns (string memory)
    {
